...
**Technologies:** Azure, Windows Server, AD DS, DNS, Linux, Key Vault, Azure Monitor, PowerShell, SQL Server

---

### [Serverless REST API on AWS with Terraform](https://github.com/AyeFuad2/terraform-rest-api)

Deployed a Python Lambda function behind API Gateway entirely through Terraform, including IAM permissions and CloudWatch logging. Diagnosed an HTTP 500 integration failure, fixed a missing Lambda resource policy, and imported an existing CloudWatch log group into Terraform state.

**Technologies:** Terraform, AWS Lambda, API Gateway, IAM, CloudWatch, Python

---

### [Enterprise Active Directory Infrastructure on AWS](https://github.com/AyeFuad2/Active-Directory-AWS-Setup)

Built an Active Directory domain using Windows Server on AWS. Created organizational units, users, and security groups before joining a second Windows server to the domain. Diagnosed a DNS-related domain-join failure and verified end-to-end domain authentication.

**Technologies:** AWS EC2, Windows Server, AD DS, DNS, Group Policy, PowerShell

---

### [AWS Web Server: Console to Terraform](https://github.com/AyeFuad2/aws-terraform-project)

Built the same AWS web-server environment manually and through Terraform to compare deployment speed and repeatability. Provisioned a custom VPC, public subnet, route table, internet gateway, security group, EC2 instance, and Apache web server.

**Technologies:** Terraform, AWS VPC, EC2, Security Groups, Apache
...
**Technologies:** Kubernetes, Amazon EKS, Docker, Amazon ECR, Flask, YAML

---

### [Amazon EKS Kubernetes Cluster](https://github.com/AyeFuad2/aws-eks-kubernetes-cluster)

Provisioned an Amazon EKS cluster and managed node group using eksctl and CloudFormation. Configured IAM access entries, investigated permission and installation errors, and explored Kubernetes resilience and self-healing.

**Technologies:** Amazon EKS, Kubernetes, eksctl, CloudFormation, IAM, EC2
...
### [Cloud Portfolio & AI-Powered Study Assistant](https://github.com/AyeFuad2/AyeFuad2.github.io)

Cloud portfolio showcasing an AI-powered study assistant built with a serverless AWS architecture.

**Technologies:** AWS Amplify, AppSync, Lambda, Amazon Bedrock, Cognito, React
...
![Fuad's GitHub Stats](https://github-readme-stats.vercel.app/api?username=AyeFuad2\&show_icons=true\&theme=dark\&hide_border=true\&bg_color=0d1117)

![Fuad's Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=AyeFuad2\&layout=compact\&theme=dark\&hide_border=true\&bg_color=0d1117)

---

## 📫 Connect With Me

[![LinkedIn](https://img.shields.io/badge/LinkedIn-Fuad_Aye-0077B5?style=flat\&logo=linkedin)](https://linkedin.com/in/fuad-aye2/)

[![Portfolio](https://img.shields.io/badge/Portfolio-AyeFuad2.github.io-181717?style=flat\&logo=github)](https://ayefuad2.github.io)

[![Email](https://img.shields.io/badge/Email-ayefuad2%40gmail.com-EA4335?style=flat\&logo=gmail)](mailto:ayefuad2@gmail.com)

---

**B.S. in Computer Information Systems — The University of Texas at Arlington**
